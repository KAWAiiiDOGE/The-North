...
namespace TheNorth
{
    ...
    {
        /// <summary>
        /// ! ДЛЯ РАБОТЫ ОБЯЗАТЕЛЬНО КИНЬТЕ ССЫЛКУ В ИНСПЕКТОРЕ !
        /// <para>
        /// Временное решение. Потом стоит переделать
        /// </para>
        /// </summary>
        /// TODO: После изменения InputHandler - удалить поле
        [field: SerializeField, Tooltip("ДЛЯ РАБОТЫ ОБЯЗАТЕЛЬНО КИНЬТЕ ССЫЛКУ В ИНСПЕКТОРЕ")] InputHandler _inputHandler;
